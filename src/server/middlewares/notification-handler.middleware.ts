...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'order_created.create': { roles: ['site-owner', 'administrator'], key: 'order_id', tenantPath: [], userPath: [] },
  'payment_received.create': {
    roles: ['site-owner', 'administrator'],
    key: 'payment_id',
    tenantPath: [],
    userPath: [],
  },
  'product_updated.update': { roles: ['site-owner', 'administrator'], key: 'product_id', tenantPath: [], userPath: [] },
};

const ownerRoles: string[] = ['site-owner'];
const customerRoles: string[] = ['customer'];
const tenantRoles: string[] = ['site-owner', 'administrator'];
