...
export function CustomerListPage(props: CustomerListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getCustomers({
        ...
        order: params.order,
        searchTermKeys: ['profile_visibility.contains', 'profile_status.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    { id: 'profile_visibility', header: 'Profile Visibility', accessorKey: 'profile_visibility' },
    { id: 'profile_status', header: 'Profile Status', accessorKey: 'profile_status' },
    {
      id: 'last_login',
      header: 'Last Login',
