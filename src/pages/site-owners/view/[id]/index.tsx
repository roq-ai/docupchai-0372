...
import { getSiteOwnerById } from 'apiSdk/site-owners';
import { SiteOwnerInterface } from 'interfaces/site-owner';

function SiteOwnerViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('site_owner', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/site-owners/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Site Name" text={data?.site_name} />

                <FormListItem label="Site Description" text={data?.site_description} />
