...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`docupchai`}</title>

        <meta
          name="description"
          content="Find Your Perfect Match with docupchai - Your Ultimate Online Dating Service. Unleash the Power of Love and Connection Today."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1556800467-7b7ba9da0bf8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxvbmxpbmUlMjBkYXRpbmd8ZW58MHx8fHwxNjk1ODI2MDczfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@graylab?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Pratik Gupta`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Find Your Perfect Match with docupchai - Your Ultimate Online Dating Service. Unleash the Power of Love and Connection Today.`}
            </Text>
            <Box
